...
const BUILTIN_MODELS: AIModel[] = [
  ...
  // Groq (cloud, free tier, ultra-fast)
  {
    ...
    providerId: "groq",
    description: "Best Groq model — 27B, fast and capable",
    speed: "fast",
    size: "27B",
    isLocal: false,
  },
  {
    ...
    provider: "Groq (Ultra-Fast)",
    providerId: "groq",
    description: "Latest Qwen — great reasoning",
    speed: "fast",
    size: "27B",
    isLocal: false,
  },
  {
    ...
    provider: "Groq (Ultra-Fast)",
    providerId: "groq",
    description: "Fast 7B — quick tasks, low latency",
    speed: "fast",
    size: "7B",
    isLocal: false,
  },
  ...
  {
    id: "dash-finetuned",
    name: "DASH (Fine-tuned)",
    provider: "Ollama (Local)",
    providerId: "ollama",
    description: "Your custom fine-tuned DASH model with JARVIS personality",
    speed: "fast",
    size: "1B",
    isLocal: true,
  },
