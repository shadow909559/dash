        ...
        return (
          <NavLink
            ...
            style={({ isActive }) => ({
              ...
              backgroundColor: isActive ? "rgba(63, 169, 245, 0.18)" : "transparent",
              border: `1px solid ${isActive ? "rgba(63, 169, 245, 0.45)" : "transparent"}`,
              boxShadow: isActive ? "0 0 20px rgba(63, 169, 245, 0.30), inset 0 0 12px rgba(63, 169, 245, 0.12)" : "none",
              textDecoration: "none",
              fontSize: 13,
