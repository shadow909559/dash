...
def sanitize_for_llm(text: str) -> str:
    ...
    """
    return sanitize_text(text, max_length=50000)
...
def sanitize_memory_context(text: str) -> str:
    ...
    """
    return sanitize_text(text, max_length=100000)

def sanitize_user_input(text: str) -> str:
    """
    Sanitize general user input.
    """
    return sanitize_text(text, max_length=20000)


def sanitize_goal_input(text: str) -> str:
    """
