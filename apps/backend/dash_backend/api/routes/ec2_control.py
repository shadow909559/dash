...
@router.get("/status")
async def ec2_status(user: User = Depends(get_current_user)) -> dict[str, Any]:
...
@router.post("/start")
async def ec2_start(user: User = Depends(get_current_user)) -> dict[str, Any]:
...
@router.post("/stop")
async def ec2_stop(user: User = Depends(get_current_user)) -> dict[str, Any]:
...
async def cloud_status(user: User = Depends(get_current_user)) -> dict[str, Any]:
