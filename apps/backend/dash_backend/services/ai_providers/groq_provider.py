"""Groq AI Provider — fastest inference via custom LPU hardware.

Groq uses an OpenAI-compatible API at api.groq.com with dramatically
faster inference than GPU-based providers.
"""
