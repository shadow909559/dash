...
from sqlalchemy import Float, ForeignKey, Index, String, Text, JSON, DateTime, Integer
...
from dash_backend.db.mixins import UUIDPrimaryKeyMixin, _utcnow
...
class Memory(UUIDPrimaryKeyMixin, Base):
    ...
    __table_args__ = (
        ...
        Index("ix_memories_user_id_project_id", "user_id", "project_id"),
    )
    ...
    # Typed memory metadata (Part 9-10: confidence and project association)
    ...
    # Python-side defaults: server_default would expire these columns after
    # INSERT/UPDATE and explode serialization with MissingGreenlet.
